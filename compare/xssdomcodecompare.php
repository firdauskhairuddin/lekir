                ...
                <div class="card card-lg">
                  <div class="card-body" style="background-color: #E5E4E2;">
                      ...
                      <pre style="background:white;border: 1px solid #000;">
                        <?php
                        highlight_file($base_path . "sourcecode/xssdomlowcode.txt");
                        ?>
                      </pre>
                      <br>
                      ...
                      <pre style="background:white;border: 1px solid #000;">
                        <?php
                        highlight_file($base_path . "sourcecode/xssdommediumcode.txt");
                        ?>
                      </pre>
                      <br>
                      ...
                      <pre style="background:white;border: 1px solid #000;">
                        <?php
                        highlight_file($base_path . "sourcecode/xssdomhighcode.txt");
                        ?>
                      </pre>
                      <br>
                      ...
                      <pre style="background:white;border: 1px solid #000;">
                        <?php
                        highlight_file($base_path . "sourcecode/xssdomimpossiblecode.txt");
                        ?>
                      </pre>
                    </div>
                  </div>
