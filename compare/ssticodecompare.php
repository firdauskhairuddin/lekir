              ...
              <div class="col-lg-12">
                <div class="card card-lg">
                  <div class="card-body" style="background-color: #E5E4E2;">
                      ...
                      <pre style="background:white;border: 1px solid #000;">
                        <?php
                        highlight_file($base_path . "sourcecode/sstimediumcode.txt");
                        ?>
                      </pre>
                      <br>
                      ...
                      <pre style="background:white;border: 1px solid #000;">
                        <?php
                        highlight_file($base_path . "sourcecode/sstihighcode.txt");
                        ?>
                      </pre>
                      <br>
                      <h3>Impossible Security Source Code <a href="sstiimpossible.php" class="btn btn-primary float-end">Go to level</a></h3>
                      <br>
                      <pre style="background:white;border: 1px solid #000;">
                        <?php
                        highlight_file($base_path . "sourcecode/sstiimpossiblecode.txt");
                        ?>
                      </pre>
                    </div>
                  </div>
