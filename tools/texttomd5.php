...
<html lang='en'>
  <head>
    ...
    <title><?php echo htmlentities($title); ?> - MD5 Generator</title>
  ...
  <body >
                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-center mb-4">
                      <div class="me-3">
                        <div class="bg-blue-lt p-2 rounded-circle">
                            <!-- Download SVG icon from http://tabler-icons.io/i/hash -->
                            <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M5 9l14 0" /><path d="M5 15l14 0" /><path d="M11 4l-4 16" /><path d="M17 4l-4 16" /></svg>
                        </div>
                      </div>
                      <div>
                        <small class="text-muted d-block">Information</small>
                        <h3 class="lh-1 m-0">MD5 Algorithm</h3>
                      </div>
                    </div>
                    ...
                    <ul class="list-unstyled info-list text-secondary">
                      <li>
                        ...
                        <div>
                            <strong>Type:</strong> Cryptographic Hash Function
                        </div>
                      </li>
                      <li>
                        ...
                        <div>
                            <strong>Hash Size:</strong> 128-bit
                        </div>
                      </li>
                      <li>
                         <svg xmlns="http://www.w3.org/2000/svg" class="icon info-icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M3 12a9 9 0 1 0 18 0a9 9 0 0 0 -18 0" /><path d="M12 9h.01" /><path d="M11 12h1v4h1" /></svg>
                        <div>
                            <strong>Use case:</strong> Verifying file integrity (checksums), storing non-sensitive data hashes. Considered weak for password storage.
                        </div>
                      </li>
                      <li>
              ...
              <div class="col-lg-8">
                <div class="card tool-card">
                  <div class="card-header">
                     <h3 class="card-title">Generator Tool</h3>
                  ...
                  <div class="card-body">
                    <div class="row g-3">
                      <div class="col-12">
                        <label class="form-label required">String Input</label>
                        <textarea class="form-control tool-textarea" id="inputText" rows="6" placeholder="Enter text to hash..." oninput="generateMD5()"></textarea>
                      </div>
                      ...
                      <div class="col-12">
                         <div class="d-flex justify-content-between mb-2">
                           <label class="form-label">MD5 Hash Output</label>
                        ...
                        <input type="text" class="form-control tool-textarea bg-muted-lt" id="md5Hash" readonly>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <script src="<?php echo $base_path; ?>dist/js/crypto-js.js"></script>
    <!-- Custom JS -->
    <script>
    ...
    function copyToClipboard() {
        var copyText = document.getElementById("md5Hash");
        copyText.select();
