...
<html lang='en'>
  <head>
    ...
    <title><?php echo htmlentities($title); ?> - Base64 Encode</title>
  ...
  <body >
                  ...
                  <div class="card-body">
                    ...
                    <ul class="list-unstyled info-list text-secondary">
                      ...
                      <li>
                        ...
                        <div>
                            <strong>Use case:</strong> Encodes binary data (or text) into ASCII characters for safe transmission over text-based protocols like HTTP or SMTP.
                        </div>
                      </li>
                      <li>
              ...
              <div class="col-lg-8">
                <div class="card tool-card">
                  <div class="card-header">
                     <h3 class="card-title">Encoder Tool</h3>
                    ...
                    <div class="row g-3">
                      <div class="col-12">
                        <div class="d-flex justify-content-between mb-2">
                            <label class="form-label required">Plain Data (Input)</label>
                        ...
                        <textarea class="form-control tool-textarea" id="inputData" rows="6" placeholder="Paste your text here..." oninput="encodeData()"></textarea>
                      </div>
                      ...
                      <div class="col-12">
                         <div class="d-flex justify-content-between mb-2">
                            <label class="form-label">Encoded Data (Output)</label>
                        ...
                        <textarea class="form-control tool-textarea bg-muted-lt" id="encodedData" rows="6" placeholder="Result will appear here..." readonly></textarea>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    function encodeData() {
      ...
      try {
          if (inputData.trim() === "") {
             document.getElementById("encodedData").value = "";
          } else {
             var encodedData = btoa(inputData);
             document.getElementById("encodedData").value = encodedData;
          }
      } catch (e) {
           document.getElementById("encodedData").value = "Encoding error";
      }
    }
    ...
    function copyToClipboard() {
        var copyText = document.getElementById("encodedData");
        copyText.select();
