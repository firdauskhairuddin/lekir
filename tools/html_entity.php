...
<html lang="en">
  <head>
    ...
    <title><?php echo htmlentities($title); ?> - HTML Entity Encoder</title>
  ...
  <body >
                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-center mb-4">
                      ...
                      <div>
                        ...
                        <h3 class="lh-1 m-0">About HTML Encoding</h3>
                      </div>
                    </div>
                    ...
                    <ul class="list-unstyled info-list text-secondary">
                      <li>
                        ...
                        <div>
                            <strong>Type:</strong> Sanitization
                        </div>
                      </li>
                      <li>
                        ...
                        <div>
                            <strong>Short Form:</strong> HTML Ent
                        </div>
                      </li>
                      <li>
                         <svg xmlns="http://www.w3.org/2000/svg" class="icon info-icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M3 12a9 9 0 1 0 18 0a9 9 0 0 0 -18 0" /><path d="M12 9h.01" /><path d="M11 12h1v4h1" /></svg>
                        <div>
                            <strong>Use case:</strong> Neutralizes dangerous characters to prevent Cross-Site Scripting (XSS) attacks.
                        </div>
                      </li>
                    </ul>
                  </div>
              ...
              <div class="col-lg-8">
                <div class="card tool-card">
                  <div class="card-header">
                     <h3 class="card-title">HTML Entity Tool</h3>
                    ...
                    <div class="row g-3">
                      <div class="col-12">
                        <div class="d-flex justify-content-between mb-2">
                            <label class="form-label required">Input HTML / Text</label>
                        ...
                        <textarea class="form-control tool-textarea" id="inputText" rows="6" placeholder='<script>alert("XSS")</script>'></textarea>
                      </div>
                      ...
                      <div class="col-12 text-center py-2">
                            <div class="btn-group">
                                ...
                                <button class="btn btn-ghost-info" onclick="decodeHtml()">
    ...
    <script>
        ...
        function decodeHtml() {
            ...
            txt.innerHTML = input;
            document.getElementById('outputText').value = txt.value;
            updateCounts();
        }
